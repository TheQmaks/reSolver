...
/**
 * CAPTCHA provider implementation for CapMonster.
 * Uses the Anti-Captcha-compatible JSON createTask/getTaskResult protocol.
 */
public class CapMonsterProvider extends JsonProtocolProvider {
